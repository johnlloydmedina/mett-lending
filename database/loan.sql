...
(7, '5', '--Select Customer--', 'new loan', '500000', '06/21/2017', 'Admin', 'Mr Segun', '09034543234', '4, ade', 'GFriend', 'img/', 'Approved', 'good', '02/09/2023', '750000', 'Admin', 'new loan', 'Pending');
...
CREATE TABLE `payments` (
  ...
  `remarks` text NOT NULL,
  `penalty_amount` int(255) NOT NULL DEFAULT 0,
  `months_delayed` varchar(255) NOT NULL DEFAULT '0 Months'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `payments` (`id`, `tid`, `account`, `account_no`, `customer`, `loan`, `pay_date`, `amount_to_pay`, `remarks`, `penalty_amount`, `months_delayed`) VALUES
(15, 'Loan=21319580', '5', '5', '5', '750000', '01/10/2023', '50000', 'sadasdsadsa', 300000, '3 Month(s)');

...
while ($row=mysqli_fetch_array($result))
		{
?>
    <a href="index.php"><div style="color: black;"><h3><strong><?php echo $row ['name'];?></strong></h3></div></a>
  </div>
  ...
  <div class="lockscreen-item">
    ...
    <form class="lockscreen-credentials" method="post" enctype="multipart/form-data">
      <div class="input-group">
        <input name="username" type="email" class="form-control" placeholder="Enter your email address">

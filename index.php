...
<div class="login-box">
  ...
  if (mysqli_num_rows($call) == 0) {
      ...
      while ($row = mysqli_fetch_assoc($call)) { ?>
   <a href="index.php"> <img src="img/<?php echo $row[
       "image"
   ]; ?>" class="img-circle" alt="User Image" width="70" height="70"></a>
   <a href="index.php"><h3 style="color: black;"><strong><?php echo $row[
       "name"
   ]; ?></strong></h3></a>
   <?php }
  }
    ...
    <form class="form"  method="post" enctype="multipart/form-data">
      ...
      <div class="form-group has-feedback">
        ...
        <div align="right">
		  ...
		  <button name="submit" type="submit" class="btn btn-primary btn-flat"><i class="fa fa-send"></i>&nbsp;Sign In</button> 
        </div>
		
		<hr>
		<div class="text-center">
    <a href="account.php">Sign in as a borrower</a>
  </div>
	<!--  <div align="center">
...
if (isset($_POST["submit"])) {
    ...
    ($query = mysqli_query(
        $link,
        "SELECT * FROM user WHERE '$username' IN(email, username) AND password = '$encrypt'"
    ...
    if ($numberOfRows == 0) {
        ...
        $_SESSION["tid"] = $row["id"];
        echo "<script>window.location='loader.php?tid=" .
            $_SESSION["tid"] .
            "';</script>";
    }
} ?>

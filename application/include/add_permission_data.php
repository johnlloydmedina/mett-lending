...
<form class="form-horizontal" method="post" enctype="multipart/form-data">
			  ...
			  <a href = "#" class = "close" data-dismiss= "alert"> &times;</a>
  				<strong>Add Module Permission</strong> | <label style="color: yellow;">Here you declare which module you want the user to get access to in their respective account.</label></div>'?>	
<div class="box-body">

			<div class="form-group">
				<label for="" class="col-sm-2 control-label" style="color:#242424">User Name:</label>
                <div class="col-sm-10">
		...
		<div align="right">
            <div class="box-footer">
				<button type="submit" class="btn btn-warning btn-flat" name="save"><i class="fa fa-save">&nbsp;Save Module</i></button>
			</div>
		</div>

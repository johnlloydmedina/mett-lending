...
?>			  				
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Account Number</label>
                  <div class="col-sm-10">
<?php
...
?>
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">First Name</label>
                  <div class="col-sm-10">
		...
		<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Last Name</label>
                  <div class="col-sm-10">
		...
		<div class="form-group">
              ...
              <div class="box-footer">
                				...
                				<button name="save" type="submit" class="btn btn-warning btn-flat"><i class="fa fa-save">&nbsp;Save</i></button>

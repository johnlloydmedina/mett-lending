...
?>
				...
				<td align="center"><a href="add_to_borrower_list.php?id=<?php echo $id; ?>&&mid=<?php echo base64_encode("410"); ?>" class="btn btn-warning btn-flat">Add to Borrower List</a></td>
				</tr>
<?php } } ?>
             </tbody>
                </table>  

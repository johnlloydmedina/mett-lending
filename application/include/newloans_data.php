...
<hr>
			...
			<div class="form-group">
				<label for="" class="col-sm-2 control-label" style="color:#242424">Gurantor's Document</label>
				<div class="col-sm-10">
...
<hr>	
			 ...
			 <div class="col-sm-10">
              <div class="input-group date">
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Loan Officer</label>
                  <div class="col-sm-10">
<?php
$tid = $_SESSION['tid'];
$sele = mysqli_query($link, "SELECT * from user WHERE id = '$tid'") or die (mysqli_error($link));
...
<?php } ?>
              ...
              <div class="box-footer">
                				...
                				<button name="save_loan" type="submit" class="btn btn-warning btn-flat"><i class="fa fa-save">&nbsp;Save</i></button>

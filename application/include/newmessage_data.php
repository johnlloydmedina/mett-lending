		...
		<form class="form-horizontal" method="post" enctype="multipart/form-data" action="process_msg.php">
		 <?php echo '<div class="alert alert-warning fade in" >
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Select Employee</label>
                  <div class="col-sm-10">
			   ...
			   <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Subject</label>
                  <div class="col-sm-10">
              ...
              <div class="box-footer">
                				...
                				<button name="send" type="submit" class="btn btn-warning btn-flat"><i class="fa fa-save">&nbsp;Send</i></button>

...
?>           
			 ...
			 <div class="form-group">
                <label for="" class="col-sm-2 control-label" style="color:#242424">Borrower</label>
				 <div class="col-sm-10">
				<?php
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Account</label>
                  <div class="col-sm-10">
		...
		<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Amount</label>
                  <div class="col-sm-10">
		 ...
		 <div class="form-group">
                  	<label for="" class="col-sm-2 control-label" style="color:#242424">Description</label>
                  	<div class="col-sm-10">
		 ...
		 <div class="form-group">
                <label for="" class="col-sm-2 control-label" style="color:#242424">Date Release</label>
			 <div class="col-sm-10">
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Agent</label>
                  <div class="col-sm-10">
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Status</label>
                  <div class="col-sm-10">
			...
			<div class="form-group">
                  	<label for="" class="col-sm-2 control-label" style="color:#242424">Remarks</label>
                  	<div class="col-sm-10">
...
<hr>	
<div class="alert-warning">&nbsp;GUARANTOR INFORMATION</div>
<hr>
				  
			<div class="form-group">
				<label for="" class="col-sm-2 control-label" style="color:#242424">Gurantor's Passport</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Relationship</label>
                  <div class="col-sm-10">
			 ...
			 <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Guarantor's Name</label>
                  <div class="col-sm-10">
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Guarantor's Phone Number</label>
                  <div class="col-sm-10">
				 ...
				 <div class="form-group">
                  	<label for="" class="col-sm-2 control-label" style="color:#242424">Guarantor's Address</label>
                  	<div class="col-sm-10">
...
<hr>	
<div class="alert-warning">&nbsp;PAYMENT INFORMATION</div>
<hr>	
					
					 <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Current Balance</label>
                  <div class="col-sm-10">
                  <input name="user" type="text" class="form-control" value="0.00" readonly>
				   ...
				   <div class="form-group">
                <label for="" class="col-sm-2 control-label" style="color:#242424">Payment Date</label>
			 <div class="col-sm-10">
              <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Amount to Pay</label>
                  <div class="col-sm-10">
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Teller By</label>
                  <div class="col-sm-10">
...
<div align="right">
              <div class="box-footer">
               <button type="submit" class="btn btn-warning btn-flat" name="add_fees"><i class="fa fa-save">&nbsp;Update Additional Fees</i></button>
...
Accepted file types <span style="color:#FF0000">jpg, gif, png, xls, xlsx, csv, doc, docx, pdf</span>
			 <input name="uploaded_file" type="file" class="btn btn-success">
			 <div align="left">
              <div class="box-footer">
                				<button type="submit" class="btn btn-warning btn-flat" name="upload"><i class="fa fa-upload">&nbsp;Upload</i></button>
              </div>
			  </div>
<?php
...
<div align="center">Fields in red are required</div>
				...
				<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Name:</label>
                  <div class="col-sm-10">
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Type of Collateral:</label>
                  <div class="col-sm-10">
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Model:</label>
                  <div class="col-sm-10">
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Make:</label>
                  <div class="col-sm-10">
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Serial Number:</label>
                  <div class="col-sm-10">
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Estimated Price:</label>
                  <div class="col-sm-10">
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Proof of Ownership:</label>
                  <div class="col-sm-10">
Accepted file types <span style="color:#FF0000">jpg, gif, png, xls, xlsx, csv, doc, docx, pdf</span>
			 <input name="uploaded_file" type="file" class="btn btn-success">
                  </div>
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Image:</label>
                  <div class="col-sm-10">
Accepted file types <span style="color:#FF0000">jpg, png </span>
			 <input name="image" type="file" class="btn btn-success">
                  </div>
                  </div>
				  
				  <div class="form-group">
                  	<label for="" class="col-sm-2 control-label" style="color:#242424">Observations:</label>
                  	<div class="col-sm-10">
...
Accepted file types <span style="color:#FF0000">jpg, png </span>
			 ...
			 <div align="left">
              <div class="box-footer">
                				<button type="submit" class="btn btn-warning btn-flat" name="submit"><i class="fa fa-save">&nbsp;Submit</i></button>
              </div>
			  </div>
<?php
...
<div align="center"><h4>Payment Schedule</h4></div>
				<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Term:</label>
                  <div class="col-sm-10">
				...
				<!--  <div class="form-group">
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Schedule of Payment:</label>
                  <div class="col-sm-10">
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Interest Rate(%):</label>
                  <div class="col-sm-10">
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Penalty(%):</label>
                  <div class="col-sm-10">
				   ...
				   <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Schedules:</label>
                  <div class="col-sm-10">
				<table>
                <tbody> 
<?php
...
<div align="right">
              <div class="box-footer">
               <button type="submit" class="btn btn-warning btn-flat" name="add_pay_schedule"><i class="fa fa-save">&nbsp;Update Collateral</i></button>

             ...
             <div class="box-body">
			  ...
			  <a href = "#" class = "close" data-dismiss= "alert"> &times;</a>
				...
				<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Select Receiver</label>
                  <div class="col-sm-10">
				...
				<div class="form-group">
					...
					<div class="form-group">
                  	<label for="" class="col-sm-2 control-label" style="color:#242424">Message</label>
                  	<div class="col-sm-10">
              ...
              <div class="box-footer">
                				...
                				<button name="send" type="submit" class="btn btn-warning btn-flat"><i class="fa fa-upload">&nbsp;Send</i></button>
              </div>
			  </div>
<?php							
if (isset($_POST['send']))

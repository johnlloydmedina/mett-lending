<div class="box">	
	       <div class="box-body">
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Company Name</label>
                  <div class="col-sm-10">
		...
		<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Company Phone</label>
                  <div class="col-sm-10">
		...
		<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Company Email</label>
                  <div class="col-sm-10">
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Company Title</label>
                  <div class="col-sm-10">
				  ...
				  <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Company Footer</label>
                  <div class="col-sm-10">
                  <input type="text" name="footer" type="text" class="form-control" value="<?php echo $row ['footer']; ?>">
				   ...
				   <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Company Abbreviation</label>
                  <div class="col-sm-10">
		...
		<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Company Currency</label>
                  <div class="col-sm-10">
		 ...
		 <div class="form-group">
                  	<label for="" class="col-sm-2 control-label" style="color:#242424">Company Address</label>
                  	<div class="col-sm-10">
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Telephone</label>
                  <div class="col-sm-10">
		...
		<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Website</label>
                  <div class="col-sm-10">
				  ...
				  <div class="form-group">
                  	<label for="" class="col-sm-2 control-label" style="color:#242424">Embed Map</label>
                  	<div class="col-sm-10">
		...
		<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Timezone</label>
                  <div class="col-sm-10">
	...
	<option timeZoneId="82" gmtAdjustment="GMT+13:00" useDaylightTime="0" value="13">(GMT+13:00) Nuku'alofa</option>
						...
						<div class="form-group">
						<label for="" class="col-sm-2 control-label">Stamp</label>
						<div class="col-sm-10">
				...
				<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#242424">Monthly Charges</label>
                  <div class="col-sm-10">

<div class="box">
	      <div class="box-body">
			...
			<div class="form-group">
                  ...
                  <input name="acte" type="text" class="form-control" placeholder="Account" required>
				   ...
				   <div class="form-group">
                <label for="" class="col-sm-2 control-label" style="color:#242424">Customer</label>
				 <div class="col-sm-10">
		 ...
		 <div class="form-group">
                <label for="" class="col-sm-2 control-label" style="color:#242424">Customer Account#</label>
				 <div class="col-sm-10">
			  ...
			  <div class="form-group">
                <label for="" class="col-sm-2 control-label" style="color:#242424">Loan</label>
				 <div class="col-sm-10">
...
<?php } ?>
		 ...
		 <div class="form-group">
              ...
              <div class="box-footer">
                				...
                				<button name="save" type="submit" class="btn btn-warning btn-flat"><i class="fa fa-save">&nbsp;Make Payment</i></button>
